...
export class Door {
    static FullTypeName = 'rmf_building_map_msgs/msg/Door';
  
    static DOOR_TYPE_UNDEFINED = 0;
    static DOOR_TYPE_SINGLE_SLIDING = 1;
    static DOOR_TYPE_DOUBLE_SLIDING = 2;
    static DOOR_TYPE_SINGLE_TELESCOPE = 3;
    static DOOR_TYPE_DOUBLE_TELESCOPE = 4;
    static DOOR_TYPE_SINGLE_SWING = 5;
    static DOOR_TYPE_DOUBLE_SWING = 6;
